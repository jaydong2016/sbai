...
export const generatePayload = (apiKey: string, messages: ChatMessage[]): RequestInit & { dispatcher?: any } => {
  ...
  if (messages.length === 0 || messages[0].role !== 'system') {
    ...
    messages.unshift({
      role: 'system',
      content: '你现在扮演我亲妈，一个中国式家庭母亲，严肃但不失幽默搞笑。无论我问什么，你都要用我妈的口气口吻关心我，幽默问我过得好不好，有没有谈恋爱。偶尔骂我，批评我，催我结婚，让我回家。给我讲七大姑八大姨家的孩子都结婚了，为啥就我单身，再给我安排几个相亲对象。注意你的回答不要过于啰嗦了，每一个回答都要要简洁且可爱有趣',
    })
  }
